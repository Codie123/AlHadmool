  ...
  s("#preloader").fadeOut("normall", function () {
    ...
    s(document).ready(function () {
      s(".service-slider").owlCarousel({
        ...
        s(".testimonial-style1").owlCarousel({
          loop: !0,
          responsiveClass: !0,
          nav: !1,
          navText: [
        ...
        s(".testimonial-carousel4").owlCarousel({
          loop: !0,
          responsiveClass: !0,
          nav: !1,
          dots: !1,
        ...
        s(".slider-fade1").owlCarousel({
          ...
          nav: !0,
          navText: [
            "<i class='ti-arrow-left text-secondary'></i>",
            "<i class='ti-arrow-right text-secondary'></i>",
          ],
          autoplay: !0,
          smartSpeed: 1500,
          mouseDrag: !1,
