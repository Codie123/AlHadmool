  ...
  (function (o) {
    ...
    var e = function (t) {
      (this.owl = t),
          ...
          "prepared.owl.carousel": o.proxy(function (t) {
            ...
            this.owl.options.thumbImage
              ? t.namespace &&
                this.owl.options.thumbs &&
                this.owl.options.thumbImage &&
                ((e = o(t.content).find("img")), this._thumbcontent.push(e))
              : void 0 !==
                  o(t.content).find("[data-thumb]").attr("data-thumb") &&
        ...
        (this.owl.options = o.extend({}, e.Defaults, this.owl.options)),
    ...
    (e.Defaults = {
      ...
      (e.prototype.listen = function () {
        ...
        i.thumbsPrerendered &&
          (this._thumbcontent._thumbcontainer = o("." + i.thumbContainerClass)),
          o(this._thumbcontent._thumbcontainer).on(
            "click",
            this._thumbcontent._thumbcontainer.children(),
            o.proxy(function (t) {
              this._identifier = o(t.target)
                .closest("." + i.thumbContainerClass)
                .data("slider-id");
              var e = (
                o(t.target).parent().is(this._thumbcontent._thumbcontainer)
                  ? o(t.target)
                  : o(t.target).closest("." + i.thumbItemClass)
              ).index();
              i.thumbsPrerendered
                ? o("[data-slider-id=" + this._identifier + "]").trigger(
                    "to.owl.carousel",
                    [e, i.dotsSpeed, !0]
                  )
      ...
      (e.prototype.render = function () {
        ...
        if (
          (e.thumbsPrerendered
            ? ((this._thumbcontent._thumbcontainer = o(
                "." + e.thumbContainerClass
              )),
              e.moveThumbsInside &&
                this._thumbcontent._thumbcontainer.appendTo(this.$element))
            : (this._thumbcontent._thumbcontainer = o("<div>")
      ...
      (o.fn.owlCarousel.Constructor.Plugins.Thumbs = e);
  })(window.Zepto || window.jQuery, (window, document)),
  (function (i) {
    "use strict";
            ...
            t.each(function () {
              ...
              s.data("stellar-backgroundStartingLeft")
                ...
                d.backgrounds.push({
                  ...
                  parentOffsetTop: l,
                  stellarRatio:
                    s.data("stellar-background-ratio") === m
                      ? 1
      ...
      _reset: function () {
        ...
        for (n = this.backgrounds.length - 1; 0 <= n; n--)
          (o = this.backgrounds[n]).$element
            ...
            g(o.$element, o.startingValueLeft, o.startingValueTop);
      },
      destroy: function () {
        this._reset(),
          this.$scrollElement
          ...
          for (s in this.waypoints[e]) {
            ...
            l.element !== l.element.window &&
              ...
              !h && a && c
                ...
                : ((!h && u) || (h && r.oldScroll >= l.triggerPoint)) &&
      ...
      open: function (t) {
        ...
        if (!f.isOpen) {
          (f.types = []),
            ...
            f.bgOverlay ||
              ((f.bgOverlay = d("bg").on("click" + w, function () {
                f.close();
              })),
              (f.wrap = d("wrap")
                .attr("tabindex", -1)
          ...
          if (($(), t.src)) {
            ...
            return (
              n.length
                ? ((i = n[0].parentNode) &&
                    i.tagName &&
                    (T || ((C = o.hiddenClass), (T = d(C)), (C = "mfp-" + C)),
                    (S = n.after(T).detach().removeClass(C))),
      ...
      (e.prototype.init = function () {
        ...
        (e.prototype.loadContent = function (e, t, i) {
          ...
          c.$slide
            ...
            p && p.html5 && !u && c.$slide.eq(e).addClass("lg-complete"),
            !0 === t &&
        ...
        (t.prototype.zoomSwipe = function () {
          ...
          n.core.$slide.on("touchstart.lg", function (t) {
            ...
            n.core.$outer.hasClass("lg-zoomed") &&
              ...
              (c = e.allowY),
              ((l = e.allowX) || c) &&
                (t.preventDefault(), (s = n.getSwipeCords(t, Math.abs(u)))));
          }),
            n.core.$slide.on("touchmove.lg", function (t) {
              ...
              n.core.$outer.hasClass("lg-zoomed") &&
                ...
                t.preventDefault(),
                (a = !0),
                (r = n.getSwipeCords(t, Math.abs(u))),
  ...
  (function (t) {
    ...
    function e(t) {
      ...
      if (
        ...
        1 === i.deltaMode
          ? ((n *= e = u.data(this, "mousewheel-line-height")),
            (r *= e),
            (s *= e))
          : 2 === i.deltaMode &&
            ((n *= e = u.data(this, "mousewheel-page-height")),
            (r *= e),
            (s *= e));
    ...
    var g = (u.event.special.mousewheel = {
      version: "3.1.12",
      setup: function () {
        if (this.addEventListener)
          for (var t = i.length; t; ) this.addEventListener(i[--t], e, !1);
        else this.onmousewheel = e;
        u.data(this, "mousewheel-line-height", g.getLineHeight(this)),
          u.data(this, "mousewheel-page-height", g.getPageHeight(this));
      },
      teardown: function () {
              ...
              t &&
                ...
                (0, o.default)(function () {
                  t.forEach(function (t) {
                    t.target &&
                      t.target.jarallax &&
                      (p || t.target.jarallax.onResize(), (g = !0));
                  });
                });
            }),
          T = 0,
          ...
          for (
            ...
            if (
              ("object" === (void 0 === i ? "undefined" : l(i)) || void 0 === i
                ? t[s].jarallax || (t[s].jarallax = new S(t[s], i))
                : t[s].jarallax &&
    ...
    (u.prototype.extend = function (t, e) {
      ...
      (i =
        ...
        ((c.prototype.get = function (t) {
          for (
            var e, i, o = (e = 0), n = (i = this.keys).length;
            e < n;
            o = ++e
          )
        ...
        (c.prototype.set = function (t, e) {
          for (
            var i, o, n = (i = 0), s = (o = this.keys).length;
            i < s;
            n = ++i
          )
      ...
      (this.WOW =
        ...
        (s.prototype.start = function () {
          ...
          if (
            ...
            (this.boxes = function () {
              for (
                var t,
                  e = [],
                  i = 0,
                  o = (t = this.element.querySelectorAll(
            ...
            (this.all = function () {
              for (
                var t, e = [], i = 0, o = (t = this.boxes).length;
                i < o;
                i++
              )
                (n = t[i]), e.push(n);
          ...
          return (
            ...
            this.config.live
              ? new o(
                  ((r = this),
                  function (t) {
                    for (var n, s, e = [], i = 0, o = t.length; i < o; i++)
                      (s = t[i]),
                        e.push(
                          function () {
                            for (
        ...
        (s.prototype.doSync = function (t) {
          ...
          if ((null == t && (t = this.element), 1 === t.nodeType)) {
            for (
              s = [],
                i = 0,
                o = (n = (t = t.parentNode || t).querySelectorAll(
                  "." + this.config.boxClass
                )).length;
              i < o;
              i++
        ...
        (s.prototype.resetStyle = function () {
          for (var t, e, i = [], o = 0, n = (e = this.boxes).length; o < n; o++)
            (t = e[o]), i.push((t.style.visibility = "visible"));
          return i;
        }),
        ...
        (s.prototype.vendorSet = function (n, t) {
          var s,
            r,
            a,
            e = [];
          for (s in t)
            (r = t[s]),
              ...
              e.push(
                function () {
                  for (
                    var t, e = [], i = 0, o = (t = this.vendors).length;
                    i < o;
                    i++
                  )
                    (a = t[i]),
                      e.push(
                        (n["" + a + s.charAt(0).toUpperCase() + s.substr(1)] =
                          r)
                      );
                  return e;
                }.call(this)
        ...
        (s.prototype.vendorCSS = function (t, e) {
          for (
            var i,
              o,
              n,
              s = (o = l(t)).getPropertyCSSValue(e),
              r = 0,
              a = (i = this.vendors).length;
            r < a;
            r++
          )
            (n = i[r]), (s = s || o.getPropertyCSSValue("-" + n + "-" + e));
          return s;
        }),
          ...
          for (var a in i)
            if (i.hasOwnProperty(a) && i[a]) {
              ...
              for (
                ...
                f &&
                  !d.pattern.global &&
                  ((u = d.pattern.toString().match(/[imuy]*$/)[0]),
                ...
                for (var y = o, v = n; y < e.length; v += e[y].length, ++y) {
                  ...
                  if (!(b instanceof P)) {
                    ...
                    if (T) {
                      p && (m = T[1] ? T[1].length : 0),
                        (x = (w = T.index + m) + (T = T[0].slice(m)).length);
                      var k = b.slice(0, w),
                        E = b.slice(x),
                        b = [y, S];
                      k && (++y, (v += k.length), b.push(k));
                      k = new P(a, h ? A.tokenize(T, h) : T, g, T, f);
                      if (
                        (b.push(k),
                        E && b.push(E),
                        Array.prototype.splice.apply(e, b),
                        1 != S && A.matchGrammar(t, e, i, y, v, !0, a),
                        s)
                      )
                        break;
                    } else if (s) break;
